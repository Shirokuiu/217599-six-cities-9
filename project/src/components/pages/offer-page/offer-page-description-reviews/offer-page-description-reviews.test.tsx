...
import OfferPageDescriptionReviews from 'src/components/pages/offer-page/offer-page-description-reviews/offer-page-description-reviews';

describe('Проверка на корректность рендера компонента OfferPageDescriptionReviews', () => {
